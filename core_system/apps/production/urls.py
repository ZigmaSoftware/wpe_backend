...
from .views import (
    ...
    ProductionLineConnectionLookupAPIView,
...
urlpatterns = [
    ...
    path("line-connections/lookup/", ProductionLineConnectionLookupAPIView.as_view(), name="line-connection-lookup"),
    path("line-connections/connect/", ProductionLineConnectionConnectAPIView.as_view(), name="line-connection-connect"),
    path("line-connections/<int:pk>/disconnect/", ProductionLineConnectionDisconnectAPIView.as_view(), name="line-connection-disconnect"),
    # Batches
